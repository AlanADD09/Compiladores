...
{
  "\"end of file\"", "error", "\"invalid token\"", "DEF", "INT_TYPE",
  "RETURN", "PRINT", "OPEN_PAREN", "CLOSE_PAREN", "OPEN_BRACE",
  "CLOSE_BRACE", "SEMICOLON", "ASSIGN", "COMMA", "IDENTIFIER",
  "INTEGER_CONSTANT", "PLUS", "MINUS", "MULTIPLY", "DIVIDE", "EQUALS",
  "NOT_EQUALS", "GREATER", "GREATER_EQUAL", "LESS", "LESS_EQUAL",
...
{
      15,    -5,     8,   -16,     5,   -16,    10,    -4,    20,     0,
     -16,   -16,     8,     8,     8,     8,   -16,   -16,   -16,   -15,
     -15,   -16,   -16
};
...
{
       8,     9,     2,    14,    15,    10,     0,    16,    18,     0,
       7,    19,    20,    21,    22,     2,    12,    13,    14,    15,
       1,    11,     2,     3,     0,     0,    12,    13,    14,    15,
       3,    17,     0,     0,     0,     0,    12,    13,    14,    15
};

static const yytype_int8 yycheck[] =
{
       1,     2,     7,    18,    19,     0,    -1,    11,     8,    -1,
      15,    12,    13,    14,    15,     7,    16,    17,    18,    19,
       5,    11,     7,    15,    -1,    -1,    16,    17,    18,    19,
      15,    11,    -1,    -1,    -1,    -1,    16,    17,    18,    19
};
...
{
       0,     5,     7,    15,    27,    28,    29,    15,    29,    29,
       0,    11,    16,    17,    18,    19,    11,    11,     8,    29,
      29,    29,    29
};
...
#line 1105 "parser.tab.c"
  ...
  case 3: /* statement: RETURN expression SEMICOLON  */
#line 29 "parser.y"
                                        { (yyval.intval) = (yyvsp[-1].intval); printf("Returning expression\n"); }
#line 1111 "parser.tab.c"
    break;

  case 4: /* statement: RETURN INTEGER_CONSTANT SEMICOLON  */
#line 30 "parser.y"
...
#line 31 "parser.y"
                                 { (yyval.intval) = (yyvsp[-1].intval); printf("Expression without return\n"); }
#line 1123 "parser.tab.c"
    break;

  case 6: /* expression: INTEGER_CONSTANT  */
#line 34 "parser.y"
                              { (yyval.intval) = (yyvsp[0].intval); }
#line 1129 "parser.tab.c"
    break;

  case 7: /* expression: OPEN_PAREN expression CLOSE_PAREN  */
#line 35 "parser.y"
                                               { (yyval.intval) = (yyvsp[-1].intval); }
